...
// update_loadings
arma::mat update_loadings(const arma::mat& F_T, arma::mat& L, const arma::mat& Y_T, const std::vector<int> update_indices, unsigned int num_iter, const bool line_search, const double alpha, const double beta);
RcppExport SEXP _plash_update_loadings(SEXP F_TSEXP, SEXP LSEXP, SEXP Y_TSEXP, SEXP update_indicesSEXP, SEXP num_iterSEXP, SEXP line_searchSEXP, SEXP alphaSEXP, SEXP betaSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(update_loadings(F_T, L, Y_T, update_indices, num_iter, line_search, alpha, beta));
    return rcpp_result_gen;
END_RCPP
}
// update_factors
arma::mat update_factors(const arma::mat& L_T, arma::mat& FF, const arma::mat& Y, const std::vector<int> update_indices, unsigned int num_iter, const bool line_search, const double alpha, const double beta);
RcppExport SEXP _plash_update_factors(SEXP L_TSEXP, SEXP FFSEXP, SEXP YSEXP, SEXP update_indicesSEXP, SEXP num_iterSEXP, SEXP line_searchSEXP, SEXP alphaSEXP, SEXP betaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< const double >::type alpha(alphaSEXP);
    Rcpp::traits::input_parameter< const double >::type beta(betaSEXP);
    rcpp_result_gen = Rcpp::wrap(update_factors(L_T, FF, Y, update_indices, num_iter, line_search, alpha, beta));
    return rcpp_result_gen;
END_RCPP
}
...
// update_loadings_logsp
arma::mat update_loadings_logsp(const arma::mat& F_T, arma::mat& L, const arma::mat& Y_T, const double s, const std::vector<int> update_indices, unsigned int num_iter, const bool line_search, const double alpha, const double beta);
RcppExport SEXP _plash_update_loadings_logsp(SEXP F_TSEXP, SEXP LSEXP, SEXP Y_TSEXP, SEXP sSEXP, SEXP update_indicesSEXP, SEXP num_iterSEXP, SEXP line_searchSEXP, SEXP alphaSEXP, SEXP betaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::mat& >::type F_T(F_TSEXP);
    ...
    Rcpp::traits::input_parameter< const double >::type alpha(alphaSEXP);
    Rcpp::traits::input_parameter< const double >::type beta(betaSEXP);
    rcpp_result_gen = Rcpp::wrap(update_loadings_logsp(F_T, L, Y_T, s, update_indices, num_iter, line_search, alpha, beta));
    return rcpp_result_gen;
END_RCPP
}
// update_factors_logsp
arma::mat update_factors_logsp(const arma::mat& L_T, arma::mat& FF, const arma::mat& Y, const double s, const std::vector<int> update_indices, unsigned int num_iter, const bool line_search, const double alpha, const double beta);
RcppExport SEXP _plash_update_factors_logsp(SEXP L_TSEXP, SEXP FFSEXP, SEXP YSEXP, SEXP sSEXP, SEXP update_indicesSEXP, SEXP num_iterSEXP, SEXP line_searchSEXP, SEXP alphaSEXP, SEXP betaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::mat& >::type L_T(L_TSEXP);
    ...
    Rcpp::traits::input_parameter< const double >::type alpha(alphaSEXP);
    Rcpp::traits::input_parameter< const double >::type beta(betaSEXP);
    rcpp_result_gen = Rcpp::wrap(update_factors_logsp(L_T, FF, Y, s, update_indices, num_iter, line_search, alpha, beta));
    return rcpp_result_gen;
END_RCPP
}
// update_loadings_sp
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_plash_update_loadings_logsp", (DL_FUNC) &_plash_update_loadings_logsp, 9},
    {"_plash_update_factors_logsp", (DL_FUNC) &_plash_update_factors_logsp, 9},
