...
// update_loadings_sp
arma::mat update_loadings_sp(const arma::mat& F_T, arma::mat& L, const arma::sp_mat& Y_T, const arma::mat& deriv_const_mat, const std::vector<int> update_indices, unsigned int num_iter, const bool line_search, const double alpha, const double beta, const double ccd_iter_tol);
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const double >::type beta(betaSEXP);
    Rcpp::traits::input_parameter< const double >::type ccd_iter_tol(ccd_iter_tolSEXP);
    rcpp_result_gen = Rcpp::wrap(update_loadings_sp(F_T, L, Y_T, deriv_const_mat, update_indices, num_iter, line_search, alpha, beta, ccd_iter_tol));
    return rcpp_result_gen;
END_RCPP
}
// update_factors_sp
arma::mat update_factors_sp(const arma::mat& L_T, arma::mat& FF, const arma::sp_mat& Y, const arma::mat& deriv_const_mat, const std::vector<int> update_indices, unsigned int num_iter, const bool line_search, const double alpha, const double beta, const double ccd_iter_tol);
