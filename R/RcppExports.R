...
update_loadings <- function(F_T, F_T_sqrd, L, Y_T, update_indices, num_iter, line_search, alpha, beta) {
    .Call(`_plash_update_loadings`, F_T, F_T_sqrd, L, Y_T, update_indices, num_iter, line_search, alpha, beta)
}

update_factors <- function(L_T, L_T_sqrd, FF, Y, update_indices, num_iter, line_search, alpha, beta) {
    .Call(`_plash_update_factors`, L_T, L_T_sqrd, FF, Y, update_indices, num_iter, line_search, alpha, beta)
}
